...
#promptinit
# promptspielereien
PROMPT='[%F{red}%D{%-0d.%-0m.%-Y %H:%M:%S}%f] %F{green}%n%f at %F{blue}%m%f in %~ %(?,%F{green}☺%f,%F{red}☹%f)
%# '
#RPROMPT=''
TMOUT=30
TRAPALRM() {
