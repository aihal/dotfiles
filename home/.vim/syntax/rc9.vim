...
syn cluster rcArgument2  contains=rcWord,@rcSimple,rcNumber,rcPattern,rcQuoted,rcSubQuote,rcParens,rcVar,rcSubst,rcJoin
...
syn keyword rcNote       sighup sigint sigalrm sigexit                         contained
...
syn keyword rcBuiltinKeyword skipwhite nextgroup=@rcArgument2 builtin cd eval exec exit flag rfork shift wait whatis 
